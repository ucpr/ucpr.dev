...
OpenTelemetry Collector を運用していく際には、Collector がどの程度の負荷に耐えられるかを事前に検証しておくことが重要です。本記事では、[telemetrygen][telemetrygen] を利用して OpenTelemetry Collector の負荷試験を簡易的に行う方法について紹介します。
